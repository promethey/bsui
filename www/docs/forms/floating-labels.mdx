...
The generated or provided control `id` is automatically assigned to the label's `htmlFor` attribute.
...
<div class="form-floating">
  <input id="example-id" />
  <label for="example-id"> Label text </label>
</div>
```

## Requirements

For Bootstrap floating labels to work correctly:

- The child component must render a native form control.
- The control must support the `placeholder` attribute.
- The placeholder value should not be empty.
