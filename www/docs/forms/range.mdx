...
export default function DefaultValue() {
  return <Form.Range min={0} max={100} defaultValue={25} />;
}
```
...
export default function MinMax() {
  return <Form.Range min={0} max={100} defaultValue={50} />;
}
```
...
export default function Step() {
  return <Form.Range min={0} max={100} step={10} defaultValue={50} />;
}
```
...
export default function Controlled() {
  ...
  return (
    <>
      ...
      />
      <Prime mt={2}>Current value: {value}</Prime>
    </>
  );
}
```
...
export default function CustomRange() {
  return <Form.Range min={10} max={50} step={5} defaultValue={30} />;
}
```
...
export default function Utilities() {
  return <Form.Range min={0} max={100} defaultValue={70} mt={3} mb={3} />;
}
```
