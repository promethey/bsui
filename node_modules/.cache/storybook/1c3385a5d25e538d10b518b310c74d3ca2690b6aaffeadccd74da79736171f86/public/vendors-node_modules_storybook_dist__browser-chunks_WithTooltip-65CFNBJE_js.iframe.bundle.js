"use strict";
(self["webpackChunkbootstrap_ui_react"] = self["webpackChunkbootstrap_ui_react"] || []).push([["vendors-node_modules_storybook_dist__browser-chunks_WithTooltip-65CFNBJE_js"],{
...
/* harmony export */   WithToolTipState: () => (/* binding */ DeprecatedState),
/* harmony export */   WithTooltip: () => (/* binding */ WithToolTipState),
/* harmony export */   WithTooltipPure: () => (/* binding */ DeprecatedPure)
/* harmony export */ });
...
/* harmony import */ var _chunk_LE2LTDW3_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./chunk-LE2LTDW3.js */ "./node_modules/storybook/dist/_browser-chunks/chunk-LE2LTDW3.js");
/* harmony import */ var _chunk_ZCFV7BZB_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./chunk-ZCFV7BZB.js */ "./node_modules/storybook/dist/_browser-chunks/chunk-ZCFV7BZB.js");
/* harmony import */ var _chunk_A242L54C_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./chunk-A242L54C.js */ "./node_modules/storybook/dist/_browser-chunks/chunk-A242L54C.js");
...
/* harmony import */ var storybook_theming__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! storybook/theming */ "./node_modules/storybook/dist/_browser-chunks/chunk-IH6QJILI.js");
...
var require_react_fast_compare = (0,_chunk_A242L54C_js__WEBPACK_IMPORTED_MODULE_3__.__commonJS)({
...
var require_warning = (0,_chunk_A242L54C_js__WEBPACK_IMPORTED_MODULE_3__.__commonJS)({
  "../../node_modules/warning/warning.js"(exports, module) {
    "use strict";
    var __DEV__ = "development" !== "production", warning2 = function() {
    };
...
var import_memoizerific = (0,_chunk_A242L54C_js__WEBPACK_IMPORTED_MODULE_3__.__toESM)((0,_chunk_ZCFV7BZB_js__WEBPACK_IMPORTED_MODULE_2__.require_memoizerific)(), 1);
...
var ManagerReferenceNodeContext = react__WEBPACK_IMPORTED_MODULE_4__.createContext(), ManagerReferenceNodeSetterContext = react__WEBPACK_IMPORTED_MODULE_4__.createContext();
...
}, useIsomorphicLayoutEffect = typeof window < "u" && window.document && window.document.createElement ? react__WEBPACK_IMPORTED_MODULE_4__.useLayoutEffect : react__WEBPACK_IMPORTED_MODULE_4__.useEffect;
...
// ../../node_modules/react-popper/lib/esm/usePopper.js
var import_react_fast_compare = (0,_chunk_A242L54C_js__WEBPACK_IMPORTED_MODULE_3__.__toESM)(require_react_fast_compare());
var EMPTY_MODIFIERS = [], usePopper = function(referenceElement, popperElement, options) {
  options === void 0 && (options = {});
  var prevOptions = react__WEBPACK_IMPORTED_MODULE_4__.useRef(null), optionsWithDefaults = {
    ...
    attributes: {}
  }), state = _React$useState[0], setState = _React$useState[1], updateStateModifier = react__WEBPACK_IMPORTED_MODULE_4__.useMemo(function() {
    return {
      name: "updateState",
      enabled: !0,
      phase: "write",
      fn: function(_ref) {
        ...
        react_dom__WEBPACK_IMPORTED_MODULE_5__.flushSync(function() {
          setState({
  ...
  }, []), popperOptions = react__WEBPACK_IMPORTED_MODULE_4__.useMemo(function() {
    var newOptions = {
  ...
  }, [optionsWithDefaults.onFirstUpdate, optionsWithDefaults.placement, optionsWithDefaults.strategy, optionsWithDefaults.modifiers, updateStateModifier]), popperInstanceRef = react__WEBPACK_IMPORTED_MODULE_4__.useRef();
...
var import_warning = (0,_chunk_A242L54C_js__WEBPACK_IMPORTED_MODULE_3__.__toESM)(require_warning());


// ../../node_modules/react-popper-tooltip/dist/esm/react-popper-tooltip.js
function useGetLatest(val) {
  var ref = react__WEBPACK_IMPORTED_MODULE_4__.useRef(val);
  return ref.current = val, react__WEBPACK_IMPORTED_MODULE_4__.useCallback(function() {
    return ref.current;
  }, []);
}
var noop = function() {
...
function useControlledState(_ref) {
  ...
  var _React$useState = react__WEBPACK_IMPORTED_MODULE_4__.useState(initial), state = _React$useState[0], setState = _React$useState[1], getLatest = useGetLatest(state), set = react__WEBPACK_IMPORTED_MODULE_4__.useCallback(function(updater) {
...
function usePopperTooltip(config, popperOptions) {
  ...
  var finalConfig = Object.keys(defaultConfig).reduce(function(config2, key) {
    var _extends2;
    return (0,_chunk_LE2LTDW3_js__WEBPACK_IMPORTED_MODULE_1__._extends)({}, config2, (_extends2 = {}, _extends2[key] = config2[key] !== void 0 ? config2[key] : defaultConfig[key], _extends2));
  }, config), defaultModifiers3 = react__WEBPACK_IMPORTED_MODULE_4__.useMemo(
    function() {
      return [{
        name: "offset",
        options: {
  ...
  ), finalPopperOptions = (0,_chunk_LE2LTDW3_js__WEBPACK_IMPORTED_MODULE_1__._extends)({}, popperOptions, {
    placement: popperOptions.placement || finalConfig.placement,
    modifiers: popperOptions.modifiers || defaultModifiers3
  }), _React$useState = react__WEBPACK_IMPORTED_MODULE_4__.useState(null), triggerRef = _React$useState[0], setTriggerRef = _React$useState[1], _React$useState2 = react__WEBPACK_IMPORTED_MODULE_4__.useState(null), tooltipRef = _React$useState2[0], setTooltipRef = _React$useState2[1], _useControlledState = useControlledState({
    initial: finalConfig.defaultVisible,
    value: finalConfig.visible,
    onChange: finalConfig.onVisibleChange
  }), visible = _useControlledState[0], setVisible = _useControlledState[1], timer = react__WEBPACK_IMPORTED_MODULE_4__.useRef();
  react__WEBPACK_IMPORTED_MODULE_4__.useEffect(function() {
    return function() {
      return clearTimeout(timer.current);
    };
  }, []);
  var _usePopper = usePopper(finalConfig.followCursor ? virtualElement : triggerRef, tooltipRef, finalPopperOptions), styles = _usePopper.styles, attributes = _usePopper.attributes, popperProps = (0,_chunk_242VQQM5_js__WEBPACK_IMPORTED_MODULE_0__._objectWithoutPropertiesLoose)(_usePopper, _excluded), update = popperProps.update, getLatest = useGetLatest({
    visible,
    triggerRef,
    tooltipRef,
    finalConfig
  ...
  ), hideTooltip = react__WEBPACK_IMPORTED_MODULE_4__.useCallback(function() {
    clearTimeout(timer.current), timer.current = window.setTimeout(function() {
      return setVisible(!1);
    }, finalConfig.delayHide);
  }, [finalConfig.delayHide, setVisible]), showTooltip = react__WEBPACK_IMPORTED_MODULE_4__.useCallback(function() {
    clearTimeout(timer.current), timer.current = window.setTimeout(function() {
      return setVisible(!0);
    }, finalConfig.delayShow);
  }, [finalConfig.delayShow, setVisible]), toggleTooltip = react__WEBPACK_IMPORTED_MODULE_4__.useCallback(function() {
  ...
  }, [getLatest, hideTooltip]), react__WEBPACK_IMPORTED_MODULE_4__.useEffect(function() {
  ...
  }, [triggerRef, isTriggeredBy, toggleTooltip]), react__WEBPACK_IMPORTED_MODULE_4__.useEffect(function() {
  ...
  }, [triggerRef, isTriggeredBy, showTooltip, hideTooltip]), react__WEBPACK_IMPORTED_MODULE_4__.useEffect(function() {
  ...
  }, [finalConfig.closeOnTriggerHidden, hideTooltip, isReferenceHidden]), react__WEBPACK_IMPORTED_MODULE_4__.useEffect(function() {
  ...
  }, [finalConfig.followCursor, triggerRef, update]), react__WEBPACK_IMPORTED_MODULE_4__.useEffect(function() {
  ...
  var getTooltipProps = function(args) {
    return args === void 0 && (args = {}), (0,_chunk_LE2LTDW3_js__WEBPACK_IMPORTED_MODULE_1__._extends)({}, args, {
      style: (0,_chunk_LE2LTDW3_js__WEBPACK_IMPORTED_MODULE_1__._extends)({}, args.style, styles.popper)
    }, attributes.popper, {
      "data-popper-interactive": finalConfig.interactive
    });
  }, getArrowProps = function(args) {
    return args === void 0 && (args = {}), (0,_chunk_LE2LTDW3_js__WEBPACK_IMPORTED_MODULE_1__._extends)({}, args, attributes.arrow, {
      style: (0,_chunk_LE2LTDW3_js__WEBPACK_IMPORTED_MODULE_1__._extends)({}, args.style, styles.arrow),
      "data-popper-arrow": !0
    });
  };
  return (0,_chunk_LE2LTDW3_js__WEBPACK_IMPORTED_MODULE_1__._extends)({
    getArrowProps,
    getTooltipProps,
    setTooltipRef,
    setTriggerRef,
...
var { document: document2 } = _storybook_global__WEBPACK_IMPORTED_MODULE_7__.global, match = (0, import_memoizerific.default)(1e3)(
  (requests, actual, value, fallback = 0) => actual.split("-")[0] === requests ? value : fallback
), ArrowSpacing = 8, Arrow = storybook_theming__WEBPACK_IMPORTED_MODULE_8__.styled.div(
  {
    position: "absolute",
    borderStyle: "solid"
  },
  ...
  ({ theme, color, placement }) => ({
    ...
    borderTopColor: match(
      "top",
      placement,
      theme.color[color] || color || theme.base === "light" ? (0,storybook_theming__WEBPACK_IMPORTED_MODULE_9__.lightenColor)(theme.background.app) : theme.background.app,
      "transparent"
    ),
...
), Wrapper = storybook_theming__WEBPACK_IMPORTED_MODULE_8__.styled.div(
  ({ hidden }) => ({
  ...
  ({ theme, color, hasChrome }) => hasChrome ? {
    background: color && theme.color[color] || color || theme.base === "light" ? (0,storybook_theming__WEBPACK_IMPORTED_MODULE_9__.lightenColor)(theme.background.app) : theme.background.app,
    filter: `
...
), Tooltip = react__WEBPACK_IMPORTED_MODULE_4___default().forwardRef(
  ({
    placement = "top",
    hasChrome = !0,
    children,
    ...
    withArrows,
    ...props
  }, ref) => react__WEBPACK_IMPORTED_MODULE_4___default().createElement(Wrapper, { "data-testid": "tooltip", hasChrome, ref, ...props, color }, hasChrome && withArrows && react__WEBPACK_IMPORTED_MODULE_4___default().createElement(Arrow, { placement, ...arrowProps, color }), children)
);
Tooltip.displayName = "Tooltip";
var TargetContainer = storybook_theming__WEBPACK_IMPORTED_MODULE_8__.styled.div`
  display: inline-block;
  cursor: ${(props) => props.trigger === "hover" || props.trigger?.includes("hover") ? "default" : "pointer"};
`, TargetSvgContainer = storybook_theming__WEBPACK_IMPORTED_MODULE_8__.styled.g`
  cursor: ${(props) => props.trigger === "hover" || props.trigger?.includes("hover") ? "default" : "pointer"};
`, WithTooltipPure = ({
  svg = !1,
  trigger = "click",
  ...
  ), portalTarget = (typeof portalContainer == "string" ? document2.querySelector(portalContainer) : portalContainer) || document2.body, tooltipComponent = isVisible ? react__WEBPACK_IMPORTED_MODULE_4___default().createElement(
    Tooltip,
    {
      placement: state?.placement,
      ref: setTooltipRef,
  ...
  return react__WEBPACK_IMPORTED_MODULE_4___default().createElement((react__WEBPACK_IMPORTED_MODULE_4___default().Fragment), null, react__WEBPACK_IMPORTED_MODULE_4___default().createElement(Container, { trigger, ref: setTriggerRef, ...props }, children), isVisible && react_dom__WEBPACK_IMPORTED_MODULE_5__.createPortal(tooltipComponent, portalTarget));
}, WithToolTipState = ({
  startOpen = !1,
  onVisibleChange: onChange,
  ...rest
}) => {
  let [tooltipShown, setTooltipShown] = (0,react__WEBPACK_IMPORTED_MODULE_4__.useState)(startOpen), onVisibilityChange = (0,react__WEBPACK_IMPORTED_MODULE_4__.useCallback)(
    (visibility) => {
  ...
  }), react__WEBPACK_IMPORTED_MODULE_4___default().createElement(WithTooltipPure, { ...rest, visible: tooltipShown, onVisibleChange: onVisibilityChange });
}, DeprecatedPure = (props) => ((0,storybook_internal_client_logger__WEBPACK_IMPORTED_MODULE_6__.deprecate)(
  "WithTooltipPure is deprecated and will be removed in Storybook 11. Please use WithTooltip instead."
), react__WEBPACK_IMPORTED_MODULE_4___default().createElement(WithTooltipPure, { "data-deprecated": "WithTooltipPure", ...props })), DeprecatedState = (props) => ((0,storybook_internal_client_logger__WEBPACK_IMPORTED_MODULE_6__.deprecate)(
  "WithToolTipState is deprecated and will be removed in Storybook 11. Please use WithTooltip instead."
), react__WEBPACK_IMPORTED_MODULE_4___default().createElement(WithToolTipState, { "data-deprecated": "WithToolTipState", ...props }));
...
//# sourceMappingURL=vendors-node_modules_storybook_dist__browser-chunks_WithTooltip-65CFNBJE_js.iframe.bundle.js.map