"use strict";
(self["webpackChunkbootstrap_ui_react"] = self["webpackChunkbootstrap_ui_react"] || []).push([["vendors-node_modules_storybook_addon-docs_dist__browser-chunks_Color-6BZIO3FS_js"],{
...
/* harmony export */ });
/* harmony import */ var _chunk_CYSK6WYR_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./chunk-CYSK6WYR.js */ "./node_modules/@storybook/addon-docs/dist/_browser-chunks/chunk-CYSK6WYR.js");
/* harmony import */ var _chunk_SL3VIQZ3_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./chunk-SL3VIQZ3.js */ "./node_modules/@storybook/addon-docs/dist/_browser-chunks/chunk-SL3VIQZ3.js");
...
/* harmony import */ var _storybook_icons__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @storybook/icons */ "./node_modules/@storybook/icons/dist/index.js");
...
var require_color_name = (0,_chunk_SL3VIQZ3_js__WEBPACK_IMPORTED_MODULE_1__.__commonJS)({
...
var require_conversions = (0,_chunk_SL3VIQZ3_js__WEBPACK_IMPORTED_MODULE_1__.__commonJS)({
...
var require_route = (0,_chunk_SL3VIQZ3_js__WEBPACK_IMPORTED_MODULE_1__.__commonJS)({
...
var require_color_convert = (0,_chunk_SL3VIQZ3_js__WEBPACK_IMPORTED_MODULE_1__.__commonJS)({
...
var import_color_convert = (0,_chunk_SL3VIQZ3_js__WEBPACK_IMPORTED_MODULE_1__.__toESM)(require_color_convert(), 1);
...
function i(e2) {
  var t2 = (0,react__WEBPACK_IMPORTED_MODULE_2__.useRef)(e2), n2 = (0,react__WEBPACK_IMPORTED_MODULE_2__.useRef)(function(e3) {
...
var s = function(e2, r2, t2) {
...
}, m = react__WEBPACK_IMPORTED_MODULE_2___default().memo(function(o2) {
  var a2 = o2.onMove, l2 = o2.onKey, s2 = c(o2, ["onMove", "onKey"]), m2 = (0,react__WEBPACK_IMPORTED_MODULE_2__.useRef)(null), g2 = i(a2), p2 = i(l2), b2 = (0,react__WEBPACK_IMPORTED_MODULE_2__.useRef)(null), _2 = (0,react__WEBPACK_IMPORTED_MODULE_2__.useRef)(!1), x2 = (0,react__WEBPACK_IMPORTED_MODULE_2__.useMemo)(function() {
    var e2 = function(e3) {
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_2__.useEffect)(function() {
    return H2;
  }, [H2]), react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", u({}, s2, { onTouchStart: C2, onMouseDown: C2, className: "react-colorful__interactive", ref: m2, onKeyDown: E2, tabIndex: 0, role: "slider" }));
}), g = function(e2) {
  return e2.filter(Boolean).join(" ");
}, p = function(r2) {
  var t2 = r2.color, n2 = r2.left, o2 = r2.top, a2 = o2 === void 0 ? 0.5 : o2, l2 = g(["react-colorful__pointer", r2.className]);
  return react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", { className: l2, style: { top: 100 * a2 + "%", left: 100 * n2 + "%" } }, react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", { className: "react-colorful__pointer-fill", style: { backgroundColor: t2 } }));
}, b = function(e2, r2, t2) {
...
var S = react__WEBPACK_IMPORTED_MODULE_2___default().memo(function(r2) {
  var t2 = r2.hue, n2 = r2.onChange, o2 = g(["react-colorful__hue", r2.className]);
  return react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", { className: o2 }, react__WEBPACK_IMPORTED_MODULE_2___default().createElement(m, { onMove: function(e2) {
    n2({ h: 360 * e2.left });
  }, onKey: function(e2) {
    n2({ h: s(t2 + 360 * e2.left, 0, 360) });
  }, "aria-label": "Hue", "aria-valuenow": b(t2), "aria-valuemax": "360", "aria-valuemin": "0" }, react__WEBPACK_IMPORTED_MODULE_2___default().createElement(p, { className: "react-colorful__hue-pointer", left: t2 / 360, color: q({ h: t2, s: 100, v: 100, a: 1 }) })));
}), T = react__WEBPACK_IMPORTED_MODULE_2___default().memo(function(r2) {
  var t2 = r2.hsva, n2 = r2.onChange, o2 = { backgroundColor: q({ h: t2.h, s: 100, v: 100, a: 1 }) };
  return react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", { className: "react-colorful__saturation", style: o2 }, react__WEBPACK_IMPORTED_MODULE_2___default().createElement(m, { onMove: function(e2) {
    n2({ s: 100 * e2.left, v: 100 - 100 * e2.top });
  }, onKey: function(e2) {
    n2({ s: s(t2.s + 100 * e2.left, 0, 100), v: s(t2.v - 100 * e2.top, 0, 100) });
  }, "aria-label": "Color", "aria-valuetext": "Saturation " + b(t2.s) + "%, Brightness " + b(t2.v) + "%" }, react__WEBPACK_IMPORTED_MODULE_2___default().createElement(p, { className: "react-colorful__saturation-pointer", top: 1 - t2.v / 100, left: t2.s / 100, color: q(t2) })));
}), F = function(e2, r2) {
  if (e2 === r2) return !0;
...
function Y(e2, t2, l2) {
  var u2 = i(l2), c2 = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)(function() {
    return e2.toHsva(t2);
  }), s2 = c2[0], f2 = c2[1], v2 = (0,react__WEBPACK_IMPORTED_MODULE_2__.useRef)({ color: t2, hsva: s2 });
  (0,react__WEBPACK_IMPORTED_MODULE_2__.useEffect)(function() {
    if (!e2.equal(t2, v2.current.color)) {
      var r2 = e2.toHsva(t2);
      v2.current = { hsva: r2, color: t2 }, f2(r2);
    }
  }, [t2, e2]), (0,react__WEBPACK_IMPORTED_MODULE_2__.useEffect)(function() {
    var r2;
    F(s2, v2.current.hsva) || e2.equal(r2 = e2.fromHsva(s2), v2.current.color) || (v2.current = { hsva: s2, color: r2 }, u2(r2));
  }, [s2, e2, u2]);
  var d2 = (0,react__WEBPACK_IMPORTED_MODULE_2__.useCallback)(function(e3) {
    f2(function(r2) {
...
var R, V = typeof window < "u" ? react__WEBPACK_IMPORTED_MODULE_2__.useLayoutEffect : react__WEBPACK_IMPORTED_MODULE_2__.useEffect, $ = function() {
...
var J = /* @__PURE__ */ new Map(), Q = function(e2) {
  ...
  var n2 = t2.className, o2 = t2.colorModel, a2 = t2.color, l2 = a2 === void 0 ? o2.defaultColor : a2, i2 = t2.onChange, s2 = c(t2, ["className", "colorModel", "color", "onChange"]), f2 = (0,react__WEBPACK_IMPORTED_MODULE_2__.useRef)(null);
  Q(f2);
  var v2 = Y(o2, l2, i2), d2 = v2[0], h2 = v2[1], m2 = g(["react-colorful", n2]);
  return react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", u({}, s2, { ref: f2, className: m2 }), react__WEBPACK_IMPORTED_MODULE_2___default().createElement(T, { hsva: d2, onChange: h2 }), react__WEBPACK_IMPORTED_MODULE_2___default().createElement(S, { hue: d2.h, onChange: h2, className: "react-colorful__last-control" }));
}, W = { defaultColor: "000", toHsva: x, fromHsva: function(e2) {
  return w({ h: e2.h, s: e2.s, v: e2.v, a: 1 });
}, equal: X }, Z = function(r2) {
  return react__WEBPACK_IMPORTED_MODULE_2___default().createElement(U, u({}, r2, { colorModel: W }));
}, ee = function(r2) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", { className: l2 }, react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", { className: "react-colorful__alpha-gradient", style: a2 }), react__WEBPACK_IMPORTED_MODULE_2___default().createElement(m, { onMove: function(e2) {
    o2({ a: e2.left });
  }, onKey: function(e2) {
    o2({ a: s(n2.a + e2.left) });
  }, "aria-label": "Alpha", "aria-valuetext": u2 + "%", "aria-valuenow": u2, "aria-valuemin": "0", "aria-valuemax": "100" }, react__WEBPACK_IMPORTED_MODULE_2___default().createElement(p, { className: "react-colorful__alpha-pointer", left: n2.a, color: k(n2) })));
}, re = function(t2) {
  var n2 = t2.className, o2 = t2.colorModel, a2 = t2.color, l2 = a2 === void 0 ? o2.defaultColor : a2, i2 = t2.onChange, s2 = c(t2, ["className", "colorModel", "color", "onChange"]), f2 = (0,react__WEBPACK_IMPORTED_MODULE_2__.useRef)(null);
  Q(f2);
  var v2 = Y(o2, l2, i2), d2 = v2[0], h2 = v2[1], m2 = g(["react-colorful", n2]);
  return react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", u({}, s2, { ref: f2, className: m2 }), react__WEBPACK_IMPORTED_MODULE_2___default().createElement(T, { hsva: d2, onChange: h2 }), react__WEBPACK_IMPORTED_MODULE_2___default().createElement(S, { hue: d2.h, onChange: h2 }), react__WEBPACK_IMPORTED_MODULE_2___default().createElement(ee, { hsva: d2, onChange: h2, className: "react-colorful__last-control" }));
};
var le = { defaultColor: "hsla(0, 0%, 0%, 1)", toHsva: H, fromHsva: k, equal: P }, ue = function(r2) {
  return react__WEBPACK_IMPORTED_MODULE_2___default().createElement(re, u({}, r2, { colorModel: le }));
};
var Ee = { defaultColor: "rgba(0, 0, 0, 1)", toHsva: z, fromHsva: function(e2) {
  var r2 = I(e2);
  return "rgba(" + r2.r + ", " + r2.g + ", " + r2.b + ", " + r2.a + ")";
}, equal: P }, He = function(r2) {
  return react__WEBPACK_IMPORTED_MODULE_2___default().createElement(re, u({}, r2, { colorModel: Ee }));
};

// src/blocks/controls/Color.tsx

var Wrapper = storybook_theming__WEBPACK_IMPORTED_MODULE_5__.styled.div({
  position: "relative",
  maxWidth: 250
}), TooltipContent = storybook_theming__WEBPACK_IMPORTED_MODULE_5__.styled.div({
  width: 200,
  margin: 5,
...
}), Swatches = storybook_theming__WEBPACK_IMPORTED_MODULE_5__.styled.div({
  display: "grid",
  ...
  marginTop: 5,
  width: 200
}), swatchBackground = (isDark) => `url('data:image/svg+xml;charset=utf-8,<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill-opacity="0.05" fill="${isDark ? "white" : "black"}"><path d="M8 0h8v8H8zM0 8h8v8H0z"/></svg>')`, SwatchColor = (0,storybook_theming__WEBPACK_IMPORTED_MODULE_5__.styled)(storybook_internal_components__WEBPACK_IMPORTED_MODULE_3__.Button)(
...
), Input = (0,storybook_theming__WEBPACK_IMPORTED_MODULE_5__.styled)(storybook_internal_components__WEBPACK_IMPORTED_MODULE_3__.Form.Input)(({ theme }) => ({
  width: "100%",
  paddingLeft: 30,
  paddingRight: 30,
...
})), PopoverTrigger = (0,storybook_theming__WEBPACK_IMPORTED_MODULE_5__.styled)(SwatchColor)(({ disabled }) => ({
  position: "absolute",
  top: 4,
  left: 4,
  zIndex: 1,
  cursor: disabled ? "not-allowed" : "pointer"
})), CycleColorSpaceButton = (0,storybook_theming__WEBPACK_IMPORTED_MODULE_5__.styled)(storybook_internal_components__WEBPACK_IMPORTED_MODULE_3__.Button)(({ theme }) => ({
  position: "absolute",
  zIndex: 1,
  top: 6,
  right: 7,
  ...
  let [value, setValue] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)(initialValue || ""), [color, setColor] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)(() => parseValue(value)), [colorSpace, setColorSpace] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)(color?.colorSpace || "hex" /* HEX */);
  ...
  let realValue = (0,react__WEBPACK_IMPORTED_MODULE_2__.useMemo)(
    ...
    [onChange]
  ), cycleColorSpace = (0,react__WEBPACK_IMPORTED_MODULE_2__.useCallback)(() => {
  ...
  let debouncedOnChange = (0,react__WEBPACK_IMPORTED_MODULE_2__.useCallback)(debounce(onChange, 200), [onChange]), { value, realValue, updateValue, color, colorSpace, cycleColorSpace } = useColorInput(
    initialValue,
    debouncedOnChange
  ), { presets, addPreset } = usePresets(presetColors ?? [], color, colorSpace), Picker = ColorPicker[colorSpace], readOnly = !!argType?.table?.readonly, controlId = (0,_chunk_CYSK6WYR_js__WEBPACK_IMPORTED_MODULE_0__.getControlId)(name);
  return react__WEBPACK_IMPORTED_MODULE_2___default().createElement(Wrapper, null, react__WEBPACK_IMPORTED_MODULE_2___default().createElement("label", { htmlFor: controlId, className: "sb-sr-only" }, name), react__WEBPACK_IMPORTED_MODULE_2___default().createElement(
    Input,
    {
      id: controlId,
      value,
    ...
    storybook_internal_components__WEBPACK_IMPORTED_MODULE_3__.PopoverProvider,
    {
      defaultVisible: startOpen,
      visible: readOnly ? !1 : void 0,
      onVisibleChange: () => color && addPreset(color),
      popover: react__WEBPACK_IMPORTED_MODULE_2___default().createElement(TooltipContent, null, react__WEBPACK_IMPORTED_MODULE_2___default().createElement(
        Picker,
        {
      ...
      ), presets.length > 0 && react__WEBPACK_IMPORTED_MODULE_2___default().createElement(Swatches, null, presets.map((preset, index) => react__WEBPACK_IMPORTED_MODULE_2___default().createElement(
        SwatchColor,
        {
  ...
  ), value ? react__WEBPACK_IMPORTED_MODULE_2___default().createElement(
    ...
    react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_storybook_icons__WEBPACK_IMPORTED_MODULE_4__.MarkupIcon, null)
  ) : null);
...
//# sourceMappingURL=vendors-node_modules_storybook_addon-docs_dist__browser-chunks_Color-6BZIO3FS_js.iframe.bundle.js.map